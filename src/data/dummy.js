...
export const EditorData = () => (
  <div>
    <h3>
    Life is a complex and beautiful journey that we all embark upon from the moment we are born. It is a continuous process of growth, change, and adaptation that allows us to experience the world in unique and meaningful ways. Throughout our lives, we encounter a multitude of challenges, joys, and sorrows that shape who we are and who we become. Life is also unpredictable and can be full of surprises, both good and bad, which can test our resilience and strength. Despite its ups and downs, life is a precious gift that we should cherish and make the most of every day. It is up to each one of us to create a fulfilling and meaningful existence, full of purpose and passion, that reflects our values and aspirations.
    </h3>
  </div>
);
